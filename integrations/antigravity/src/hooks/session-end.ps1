# =============================================================================
# DevBrain x Antigravity -- session-end.ps1
...
#       Heavy work runs in a background job so Antigravity exits immediately.
# =============================================================================
...
# Detach -- don't wait for the job, let Antigravity exit cleanly
